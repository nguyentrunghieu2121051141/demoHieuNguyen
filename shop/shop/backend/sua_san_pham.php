    ...
    <div class="panel-body">
        <form action="" method="POST" enctype="multipart/form-data" role="form">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" name="noidung" value="<?php echo $rowSP['noidung']; ?>">
            </div>
            <div class="form-group">
                <label for="">Chi tiết</label>
                <input type="text" class="form-control" name="noidungchitiet" value="<?php echo $rowSP['noidungchitiet']; ?>">
            </div>
            <div class="form-group">
