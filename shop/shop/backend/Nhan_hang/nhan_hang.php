        ...
        <tbody>
            ...
            <?php foreach ($catelog as $row) : ?>
                <tr>
                    ...
                    <td>
                        <a href="/shop/backend/Nhan_hang/sua_nhan_hang.php?Catid=<?php echo $row['catelogid']; ?>" class="btn btn-xs btn-primary">Sửa</a>
                        <a href="/shop/backend/Nhan_hang/xoa_nhan_hang.php?Catid=<?php echo $row['catelogid']; ?>" class="btn btn-xs btn-danger">Xóa</a>
                    </td>
                </tr>
            <?php endforeach; ?>
        </tbody>
